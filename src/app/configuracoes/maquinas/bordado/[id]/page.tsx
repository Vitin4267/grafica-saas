...
import { MaquinaBordadoForm } from "./MaquinaBordadoForm";

export default async function MaquinaBordadoDetalhePage({
  params,
}: {
      ...
      <main className="mx-auto w-full max-w-3xl flex-1 px-6 py-10">
        ...
        <div className="mb-8">
          ...
          <p className="mt-1 text-slate-500">
            Esses valores afetam todos os produtos Bordado que usam esta máquina.
          </p>
        </div>
        ...
        <MaquinaBordadoForm
          ...
          valoresIniciais={{
            nome: maquina.nome,
            ativa: maquina.ativa,
            custoPorMilPontos: maquina.custoPorMilPontos.toString(),
