...
import { CategoriaCustoForm } from "./CategoriaCustoForm";

export default async function CategoriaCustoDetalhePage({
  params,
}: {
      ...
      <main className="mx-auto w-full max-w-3xl flex-1 px-6 py-10">
        ...
        <div className="mb-8">
          ...
          <p className="mt-1 text-slate-500">
            Renomeie ou desative esta categoria de custo real.
          </p>
        </div>
